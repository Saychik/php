    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">I am <?= $full_name; ?></h1>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span><?= $full_name; ?></span></p>
                        <p><span class="title-s">Profile: </span> <span><?= $profession; ?></span></p>
